  ...
  return (
    <>
      <div className="flex w-full h-12">
        ...
        <Link to={`/imports/camera${label ? '?label=' + label : ''}`} type="button" className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
